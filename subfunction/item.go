...
func (f *SubFunction) OrdersItem(
	...
	rows, err := f.db.Query(
		...
		DeliverToPlantBatchValidityEndDate,DeliverToPlantBatchValidityStartTime,
		DeliverToPlantBatchValidityEndTime, DeliverFromPlant, DeliverFromPlantTimeZone, DeliverFromPlantStorageLocation,
		ProductIsBatchManagedInDeliverFromPlant, BatchMgmtPolicyInDeliverFromPlant, DeliverFromPlantBatch,
		DeliverFromPlantBatchValidityStartDate, DeliverFromPlantBatchValidityEndDate, DeliverFromPlantBatchValidityStartTime, DeliverFromPlantBatchValidityEndTime, DeliveryUnit, StockConfirmationBusinessPartner,
		...
		StockConfirmationPlantBatchValidityEndDate, StockConfirmationPlantBatchValidityStartTime,
		StockConfirmationPlantBatchValidityEndTime, OrderQuantityInBaseUnit, OrderQuantityInDeliveryUnit, StockConfirmationPolicy,
		...
		ProductionPlantBatchValidityStartDate, ProductionPlantBatchValidityEndDate, ProductionPlantBatchValidityStartTime, ProductionPlantBatchValidityEndTime, Incoterms, TransactionTaxClassification,
